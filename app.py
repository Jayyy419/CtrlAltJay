        ...
        if has_data == 0:
            ...
            seed_items = [
                ...
                (
                    ...
                    "Build and strengthen partnerships with industry leaders, professionals, and key stakeholders to drive impactful career support initiatives. Engage in the technical side of the Networks department and helped restructure database and technologies. Through events, mentorship programs, and collaborative projects, help create a bridge between students and industry experts.",
                    "Joined",
                    "Aug 2024 - Present",
                ...
                (
                    ...
                    "External Roles - Regional Organization",
                    "Led operational and financial functions to strengthen organisational sustainability and programme delivery. Redesigned internal workflows, budgeting, and reporting structures to improve transparency, coordination, and execution across regional teams.",
                    "Supported the delivery of student-facing programmes, talks, and initiatives aimed at improving youth awareness of regional issues, civic engagement, and leadership pathways. Worked closely with cross-functional stakeholders in a volunteer-driven environment.",
                    "Joined",
                    "Jul 2025 - Present",
                    "Workflow redesign, budgeting, reporting structures",
                    "Coordinating across regional volunteer teams",
                    "Expand programme reach across ASEAN",
                    "",
                    "",
                    "",
                    seed_now,
                ...
                (
                    ...
                    "Worked with diverse teams to support ground-up initiatives addressing community needs, while developing skills in teamwork, communication and responsible leadership. Gained exposure to Singapore's social sector and the role of youths in creating sustainable and community-centred change.",
                    "Joined",
                    "Oct 2025 - Present",
                    "Community engagement and leadership training",
                    "Balancing volunteer commitments with studies",
                    "Take on mentoring roles in future cohorts",
                    "",
                    "",
                    "",
                    seed_now,
                ...
                (
                    "experience",
                    "Volunteer",
                    "Volunteer - Cyber Youth Collective",
                    "YouthTechSG",
                    "Volunteer - Tech Movement",
                    "Part of Singapore's largest youth-in-tech movement (previously Cyber Youth Singapore), empowering youths from all walks of life and championing digital resilience, opportunity, and representation.",
                    "Collaborating with partners across government, industry, and education on programmes team initiatives.",
                    "Joined",
                    "Jun 2025 - Present",
                    "Programme support and youth engagement",
                    "Aligning diverse stakeholder interests",
                    "Lead programme tracks independently",
                    "",
                    "",
                    "",
                    seed_now,
                ...
                (
                    ...
                    "Nanyang Polytechnic AWS Cloud Club",
                    "External Roles - Cloud Computing",
                    "Organised workshops and hands-on projects to help members deepen their understanding of AWS and cloud computing.",
                    "Facilitated knowledge-sharing sessions and supported collaborative initiatives, helping peers apply cloud technologies to real-world problems. Strengthened technical skills, teamwork and organisational abilities while fostering a collaborative innovation environment.",
                    "Joined",
                    "Apr 2024 - Present",
                    "Workshops, hands-on cloud projects",
                    "Engaging members with varying skill levels",
                    "Scale the club's impact and partnerships",
                    "",
                    "",
                    "",
                    seed_now,
                ...
                (
                    ...
                    "External Roles",
                    "Head of Liaison",
                    "Nanyang Polytechnic LEO Club",
                    "External Roles - Community Service",
                    "Led external liaison for the LEO Club, managing communications and partnerships with external organisations.",
                    "",
                    "Period",
                    "Apr 2024 - Mar 2025",
                    "External partnership management",
                    "Navigating multiple stakeholder priorities",
                    "",
                    "",
                    "",
                    "",
                ...
                (
                    ...
                    "External Roles - Student Committee",
                    "Supported the planning and execution of sports and social activities for students within the School of Information Technology.",
                    "Assisted with coordination, logistics and administrative matters, including scheduling and internal communications. Worked closely with committee members to ensure smooth event operations and positive student engagement.",
                    "Period",
                    "Oct 2023 - Mar 2025",
                    "Event coordination and logistics",
                    "Managing schedules across multiple events",
                    "",
                    "",
                    "",
                    "",
                ...
                (
                    ...
                    "NYP InfoSec",
                    "External Roles - Cybersecurity",
                    "Contributed to cybersecurity awareness and activities within the InfoSec interest group.",
                    "",
                    "Period",
                    "Mar 2024 - Feb 2025",
                    "Cybersecurity events and awareness",
                    "",
                    "",
                    "",
                    "",
                ...
                (
                    ...
                    "Sub-Committee Member",
                    "NYP AI",
                    "External Roles - Artificial Intelligence",
                    "Contributed to AI-focused activities and initiatives within the NYP AI interest group.",
                    "",
                    "Period",
                    "Feb 2024 - Jan 2025",
                    "AI events and knowledge sharing",
                    "",
                    "",
                    "",
                    "",
                ...
                (
                    ...
                    "Received Director's List recognition for academic excellence.",
                    "",
                    "Year",
                    "",
                    "",
                ...
                (
                    "experience",
                    "Achievements",
                    "1st Place / Most Innovative Solution",
                    "Overseas Innovation Challenge (OIC)",
                    "Achievements - Competition",
                    "Won 1st Place and Most Innovative Solution award at the Overseas Innovation Challenge.",
                    "",
                    "Year",
                    "",
                    "",
                ...
                (
                    ...
                    "AWS Educate",
                    "Certifications - AWS",
                    "Completed machine learning fundamentals through AWS DeepRacer programme.",
                    "",
                    "Completed",
                    "",
                    "",
                ...
                (
                    ...
                    "Foundational understanding of generative AI concepts and applications.",
                    "",
                    "Completed",
                    "",
                    "",
                ...
                (
                    ...
                    "Preparation and study for CompTIA A+ Core 1 hardware and networking fundamentals.",
                    "",
                    "Completed",
                    "",
                    "",
            ...
            seed_resume = [
                ...
                (
                    ...
                    "Diploma in Energy Management and Systems",
                    "Apr 2018 - Apr 2020",
                    "Withdrawn. Transitioned to Information Technology at Nanyang Polytechnic.",
                    3,
                    seed_now,
                    seed_now,
                ),
                ...
                (
                    ...
                    "Naval Warfare Systems Operator (NSF)",
                    "Apr 2021 - Feb 2023",
                    "Part of the Maritime Security Task Force under the Sea Security Group. Operated advanced naval combat and surveillance systems for real-time threat monitoring, identification, and response.",
                    2,
                    seed_now,
                    seed_now,
                ),
                (
                    ...
                    "Jun 2020 - Dec 2020",
                    "Handled customer calls for the BYOB campaign under Temasek Foundation. Coordinated with internal teams for accurate messaging and smooth campaign execution.",
                    3,
                    seed_now,
                    seed_now,
                ),
                (
                    ...
                    "Event Crew",
                    "Sep 2023 - Nov 2023",
                    "Ensured smooth operations and maintained organisation of event spaces during conventions and exhibitions.",
                    4,
                    seed_now,
                    seed_now,
                ),
                (
                    ...
                    "Stewarding Crew",
                    "Jan 2018 - Jan 2021",
                    "Coordinated with event staff, handled setup and breakdown tasks for conventions and exhibitions in a fast-paced environment.",
                    5,
                    seed_now,
                    seed_now,
                ),
            ...
            seed_skills = [
                ...
                ("Agile Methodologies", 70, "Scrum and iterative delivery", 6, seed_now, seed_now),
                ("Airtable", 68, "Workflow and data management", 7, seed_now, seed_now),
            ]
